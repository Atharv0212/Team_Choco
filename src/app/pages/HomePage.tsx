        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            ...
            >
              ...
              >
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-violet-500/20 flex items-center justify-center mb-4 md:mb-6 text-violet-400 group-hover:scale-110 transition-transform">
                  <Sparkles className="w-6 h-6 md:w-7 md:h-7" />
                </div>
                <h3 className="text-xl md:text-2xl text-white mb-2 md:mb-3 tracking-tight">
                  Smart Features
                </h3>
                <p className="text-slate-400 mb-3 md:mb-4 leading-relaxed text-sm md:text-base">
            ...
            >
              ...
              >
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-orange-500/20 flex items-center justify-center mb-4 md:mb-6 text-orange-400 group-hover:scale-110 transition-transform">
                  <Atom className="w-6 h-6 md:w-7 md:h-7" />
                </div>
                <h3 className="text-xl md:text-2xl text-white mb-2 md:mb-3 tracking-tight">
                  The Science
                </h3>
            ...
            >
              ...
              >
                <div className="w-12 h-12 md:w-14 md:h-14 rounded-xl bg-slate-900/50 flex items-center justify-center mb-4 md:mb-6 text-white group-hover:scale-110 transition-transform">
